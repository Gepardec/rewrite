...
public class ChangeProfileDependencyGroupIdAndArtifactId extends Recipe {
    ...
    @Option(displayName = "Old groupId",
            description = "The old groupId to replace. The groupId is the first part of a profile dependency coordinate `com.google.guava:guava:VERSION`.",
            example = "org.openrewrite.recipe")
    String oldGroupId;

    @Option(displayName = "Old artifactId",
            description = "The old artifactId to replace. The artifactId is the second part of a profile dependency coordinate `com.google.guava:guava:VERSION`.",
    ...
    public ChangeProfileDependencyGroupIdAndArtifactId(String oldGroupId, String oldArtifactId, String newGroupId, String newArtifactId, @Nullable String newVersion) {
    ...
    @JsonCreator
    public ChangeProfileDependencyGroupIdAndArtifactId(String oldGroupId, String oldArtifactId, String newGroupId, String newArtifactId, @Nullable String newVersion, @Nullable String versionPattern) {
        this.oldGroupId = oldGroupId;
        this.oldArtifactId = oldArtifactId;
        this.newGroupId = newGroupId;
        this.newArtifactId = newArtifactId;
    ...
    public String getDisplayName() {
        return "Change Maven profile dependency groupId, artifactId and optionally the version";
    }

    @Override
    public String getDescription() {
        return "Change the groupId, artifactId and optionally the version of a specified Maven profile dependency.";
    }
    ...
    public TreeVisitor<?, ExecutionContext> getVisitor() {
        return new MavenIsoVisitor<ExecutionContext>() {
            ...
            public Xml.Tag visitTag(Xml.Tag tag, ExecutionContext ctx) {
                ...
                if (isProfileDependencyTag(oldGroupId, oldArtifactId)) {
